...
export default function Carousel() {
  ...
  /* Left arrow একটু বাম সরানো */
  .slick-prev {
    left: 10px; /* এখানে px মান পরিবর্তন করে position ঠিক করতে পারবেন */
  }

  /* Right arrow একটু ডান সরানো (যদি চান) */
  .slick-next {
    right: 15px; /* এখানে px মান পরিবর্তন করে position ঠিক করতে পারবেন */
  }
